#!/bin/sh
#
# Package a built frida-server + frida-agent.dylib into a rootless iOS .deb
# (/var/jb layout, roothide Dopamine / rootless jailbreaks).
# Adapted from miticollo's package-server-fruity.sh.
#
...
Maintainer: Ole Andre Vadla Ravnas <oleavr@nowsecure.com>
